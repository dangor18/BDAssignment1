...
\label{sec:org340bb3e}
\subsection{Data Set Explanation}
\label{sec:orgd02d17a}
...
\begin{itemize}
\item A \texttt{user\_id} and \texttt{user\_name} (randomly generated, as explained in ``\hyperref[sec:org6438948]{Data Pre-Processing}'').
\item A \texttt{ratings} list:
\begin{itemize}
...
\label{sec:org5f8ae12}
\subsection{MongoDB (Document Store)}
\label{sec:org94beae4}
...
\label{sec:orgf7affd7}
\subsection{GRDDAN017}
\label{sec:org0c7b405}
\subsubsection{1}
\label{sec:org8d02bbd}
\textbf{Description}\\
...
\label{sec:org02a0ae0}
\subsubsection{1}
\label{sec:org821d13c}
\textbf{Description}\\
...
\label{sec:org906e80e}
\subsubsection{1}
\label{sec:orgc4c9ef2}
\textbf{Description}\\
