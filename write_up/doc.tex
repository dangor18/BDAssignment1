...
\label{sec:orgd8a81a5}
\subsection{Data Set Explanation}
\label{sec:orgdc5a015}
...
\begin{itemize}
\item A \texttt{user\_id} and \texttt{user\_name} (randomly generated, as explained in ``\hyperref[sec:org4e42aa2]{Data Pre-Processing}'').
\item A \texttt{ratings} list:
\begin{itemize}
...
\label{sec:org2270cc0}
\subsection{MongoDB (Document Store)}
\label{sec:orgfca4776}
...
\label{sec:org1ec7983}
\subsection{GRDDAN017}
\label{sec:org5dbc366}
\subsubsection{1}
\label{sec:orgb7ca4a1}
\textbf{Description}\\
...
\label{sec:org11e4e97}
\subsubsection{1}
\label{sec:org3254ea3}
\textbf{Description}\\
...
\label{sec:org4a7ef5e}
\subsubsection{1}
\label{sec:orgbec9f99}
\textbf{Description}\\
