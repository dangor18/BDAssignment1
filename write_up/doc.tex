...
\label{sec:orgd9cd3e4}
\subsection{Data Set Explanation}
\label{sec:org9353ca1}
...
\begin{itemize}
\item A \texttt{user\_id} and \texttt{user\_name} (randomly generated, as explained in ``\hyperref[sec:orge5e0032]{Data Pre-Processing}'').
\item A \texttt{ratings} list:
\begin{itemize}
