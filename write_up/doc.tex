...
\label{sec:org5095b93}
\subsection{Data Set Explanation}
\label{sec:orga9332ba}
...
\begin{itemize}
\item A \texttt{user\_id} and \texttt{user\_name} (randomly generated, as explained in ``\hyperref[sec:org8a423e0]{Data Pre-Processing}'').
\item A \texttt{ratings} list:
\begin{itemize}
...
\label{sec:orgd3b6182}
\subsection{MongoDB (Document Store)}
\label{sec:org2debd35}
