...
\begin{itemize}
\item A \texttt{user\_id} and \texttt{user\_name} (randomly generated, as explained in ``\hyperref[sec:org500a8bc]{Data Pre-Processing}'').
\item A \texttt{ratings} list:
\begin{itemize}
...
\label{sec:orgca7435d}
\subsubsection{1}
\label{sec:orgec233d5}
\textbf{Description}\\
...
\label{sec:orgc4df649}
\subsubsection{1}
\label{sec:org02696f2}
\textbf{Description}\\
...
\label{sec:org892163e}
\subsubsection{1}
\label{sec:org806847c}
\textbf{Description}\\
