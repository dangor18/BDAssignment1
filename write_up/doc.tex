...
\label{sec:orgc711ad5}
\subsection{Data Set Explanation}
\label{sec:orgecfd7b9}
...
\begin{itemize}
\item A \texttt{user\_id} and \texttt{user\_name} (randomly generated, as explained in ``\hyperref[sec:orgfad6ff9]{Data Pre-Processing}'').
\item A \texttt{ratings} list:
\begin{itemize}
