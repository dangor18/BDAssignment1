...
\label{sec:org36846e3}
\subsection{Data Set Explanation}
\label{sec:org9b2fdba}
...
\begin{itemize}
\item A \texttt{user\_id} and \texttt{user\_name} (randomly generated, as explained in ``\hyperref[sec:org85ecbb8]{Data Pre-Processing}'').
\item A \texttt{ratings} list:
\begin{itemize}
...
\label{sec:orgced2b30}
\subsection{MongoDB (Document Store)}
\label{sec:orge8a0e2f}
...
\label{sec:org42a868c}
\subsection{GRDDAN017}
\label{sec:org3a30bdf}
\subsubsection{1}
\label{sec:org3b590fd}
\textbf{Description}\\
...
\label{sec:org5f30c55}
\subsubsection{1}
\label{sec:org10a3b2a}
\textbf{Description}\\
...
\label{sec:org69fa1b5}
\subsubsection{1}
\label{sec:orgde03592}
\textbf{Description}\\
...
\label{sec:org9e85a84}
\subsubsection{1}
\label{sec:orgb0ff12b}
\textbf{Description}\\
...
\label{sec:orgae8a860}
\subsubsection{1}
\label{sec:org7cf0791}
\textbf{Description}\\
